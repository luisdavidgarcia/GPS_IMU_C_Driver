...
void download_map(const std::vector<std::pair<double, double> >& coordinates, const std::string& api_key = "", int zoom = 23, const std::string& size = "800x600", const std::string& filename = "map_image.png") {
    CURL *curl;
    CURLcode res;
