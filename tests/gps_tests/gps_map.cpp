...
void download_map(const std::vector<std::pair<double, double> >& coordinates, const std::string& api_key = "", int zoom = 20, const std::string& size = "1200x1200", const std::string& filename = "map_image.png") {
    CURL *curl;
    CURLcode res;
