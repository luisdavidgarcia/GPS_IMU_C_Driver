...
kalman_test:
	g++ -std=c++17 gps_module/gps.cpp ubx_lib/ubx_msg.cpp tests/gps_tests/test_gps.cpp extended_kalman_filter/ekfNavINS.cpp -o test_gps $(FLAGS) -I /usr/include/eigen3
